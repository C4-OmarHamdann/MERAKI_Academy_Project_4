    ...
    <>
      <div className="aside-left">
        <div className="aside-left-items">
          <a className="aside-left-item" href="/">
            <svg
          ...
          <a class="aside-left-item" href="/home">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
              ...
              fill="#fff"
              xmlns="http://www.w3.org/2000/svg"
              class="StyledIconBase-ea9ulj-0 bWRyML sc-jSgvzq latfBt"
            >
          ...
          <a class="aside-left-item" href="/home">
            <svg
              ...
              fill="#fff"
              xmlns="http://www.w3.org/2000/svg"
              class="StyledIconBase-ea9ulj-0 bWRyML sc-gKseQn bxeuMb"
            >
          ...
          <a class="aside-left-item" href="/home">
            <svg
              ...
              fill="#fff"
              xmlns="http://www.w3.org/2000/svg"
              class="StyledIconBase-ea9ulj-0 bWRyML sc-iBPTik ekjHVv"
            >
          ...
          <a class="aside-left-item" href="/home">
            <svg
              ...
              fill="#fff"
              xmlns="http://www.w3.org/2000/svg"
              class="StyledIconBase-ea9ulj-0 bWRyML sc-fubCzh cWgqFW"
            >
          ...
          <a class="aside-left-item" href="/home">
            <svg
              ...
              fill="#fff"
              xmlns="http://www.w3.org/2000/svg"
              class="StyledIconBase-ea9ulj-0 bWRyML sc-pGacB klEDOB"
            >
          ...
          <a class="aside-left-item" href="/home">
            <svg
              ...
              fill="#fff"
              xmlns="http://www.w3.org/2000/svg"
              class="StyledIconBase-ea9ulj-0 bWRyML sc-jrAFXE bxlbPA"
            >
